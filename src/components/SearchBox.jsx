...
const SearchBox = ({ setIsModalVisible, setWoeid }) => {
  ...
  const getLocation = () => {
    getLocations().catch((e) => console.error(e.message));
  };
  ...
  return (
    <div className="w-full min-h-full absolute top-0 left-0 z-10 bg-navyBlue-light text-gray-light font-rale font-medium p-4 flex flex-col xl:static xl:h-full">
      <CloseIcon
        tabIndex="0"
      ...
      <div className="w-full mt-9 mb-7 flex flex-row gap-3">
        <div className="flex-1 border border-gray-light p-4 flex gap-4 focus-within:ring-2 focus-within:ring-blue-400">
      ...
      <ul>
        ...
        {error && <li>Error. Please try again.</li>}
        {data
