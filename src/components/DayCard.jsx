...
const DayCard = ({ weather, unit }) => {
  ...
  return (
    <div className="w-30 h-44 p-4 bg-navyBlue-light flex align-middle justify-center flex-col">
      <div
        className="w-max mx-auto text-gray-light text-base"
        data-testid="DayCardDate"
      >
      ...
      <img
        ...
        data-testid="DayCardImg"
      />
      <div className="w-full m-auto flex justify-center gap-4">
        <div className="text-gray-light text-base" data-testid="DayCardTempMax">
          {Math.round(tempMax)}
          {unit === "F" ? "℉" : "℃"}
        </div>
        <div className="text-gray-text1 text-base" data-testid="DayCardTempMin">
          {Math.round(tempMin)}
          {unit === "F" ? "℉" : "℃"}
        </div>
      </div>
