...
const Today = ({ weather, city, setCoords }) => {
  const handleClick = (e) => {
  ...
  return (
    <div className="bg-navyBlue-light pb-24 xl:col-span-1 xl:row-span-3">
      ...
      <div className="h-bg bg-center relative flex align-middle">
        <img src={getImage(weather?.weather_state_abbr)} alt="clear" className="m-auto" />
        <div
      ...
      <p className="m-auto -mt-12 w-max text-10xl text-gray-light">
        {weather && Math.round(weather?.the_temp)}
      ...
      <div className="m-auto mt-12 w-max flex gap-4 text-gray-text1">
        <div className="capitalize">{relativeDate(weather?.applicable_date)}</div>
        <div>•</div>
